        ...
        <table className="w-full text-xl border-collapse">
            <thead>
                <tr className="text-sm text-gray-500 uppercase tracking-wide border-b border-gray-700">
                    ...
                    <th className="text-left font-normal border-r border-dotted border-gray-700">
                        <Link href="/about" onClick={(e) => e.stopPropagation()} className="flex items-center gap-1 py-1 px-4 hover:text-gray-300">
                            Real Feel <span className="text-gray-600">(?)</span>
                        </Link>
                    </th>
                    <th className="text-left font-normal border-r border-dotted border-gray-700">
                        <Link href="/about" onClick={(e) => e.stopPropagation()} className="flex items-center gap-1 py-1 px-2 hover:text-gray-300">
